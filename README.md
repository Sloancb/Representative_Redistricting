...
We are both very proud that our algorithm worked and that it worked well.  It was something that we had devised ourselves, no pre-planning, no use of AI, so seeing it work to generate districts was very rewarding.  It especially felt good to see the visualization and look at our generated district map for Ohio, then compare it against the actual congressional map and see that our map was relatively similar to what is actually in use.
...
## What's next for Anti-Gerrymandering 
